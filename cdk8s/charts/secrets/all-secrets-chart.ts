...
export class AllSecretsChart extends Chart {
  ...
  constructor(scope: Construct, id: string, props?: ChartProps) {
    ...
    // ---------------------------------------------------------------------
    const appEnvSecret = createEnvExternalSecret(this, 'app-env-es', {
      externalName: 'app-env',
      name: 'app-env',
      namespace: 'nextjs',
      refreshInterval: '1h',
    ...
    appEnvSecret.addJsonPatch(JsonPatch.add('/metadata/annotations', { 'argocd.argoproj.io/sync-wave': '-25' }));
