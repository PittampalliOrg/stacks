...
export interface AiplatformengineeringProps {
...
export class Aiplatformengineering extends Construct {
  public constructor(scope: Construct, id: string, props: AiplatformengineeringProps = {}) {
    super(scope, id);
    let updatedProps = {};
